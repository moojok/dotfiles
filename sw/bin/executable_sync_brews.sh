...
if ! command -v zinit >/dev/null; then
	...
	curl -sSL https://raw.githubusercontent.com/zdharma-continuum/zinit/HEAD/scripts/install.sh | bash
fi
...
if [[ ${OSTYPE} == 'darwin'* ]]; then
	...
	# trunk-ignore(shellcheck/SC2296) zsh related
